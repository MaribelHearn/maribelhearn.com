...
const releaseDate = {
    ...
    "EoSD": "2002-08-11", "EoSD-NC": "2026-09-09", "PCB": "2003-08-17", "IN": "2004-08-15", "PoFV": "2005-08-14", "MoF": "2007-08-17", "SA": "2008-08-16", "UFO": "2009-08-15", "GFW": "2010-08-14",
...
function showWRtable(game, records) {
    ...
    for (const data of records) {
        ...
        if (videoEnabled && data.video) {
            text = `<a class='replay' href='${data.video}' target='_blank'>${text}↗</a>`;
        } else if (data.replay) {
