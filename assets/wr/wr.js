...
function generateText() {
    ...
    if (language == "English") {
        ...
        $(".th17").html("Touhou 17 - Wily Beast and Weakest Creature");
        $(".Makai").html("Makai");
        $(".Jigoku").html("Jigoku");
        $(".ReimuA").html("ReimuA");
        $(".ReimuB").html("ReimuB");
        ...
        $("#description").html("An accurate list of Touhou world records, updated every so often. Note that the " +
                "player ranking at the bottom does not take into account how strong specific records are, only numbers. The list does not include scene games as of now.");
        ...
        $("#lastupdate").html("World records are current as of " + (notation == "DMY"
            ? translateDate(lastUpdate, "DMY")
            : lastUpdate) + ".");
        ...
        $(".th17").html("東方鬼形獣　～ Wily Beast and Weakest Creature");
        $(".Makai").html("魔界");
        $(".Jigoku").html("地獄");
        $(".ReimuA").html("霊夢A");
        $(".ReimuB").html("霊夢B");
        ...
        $(".th17").html("东方鬼形獣　～ Wily Beast and Weakest Creature");
        $(".Makai").html("魔界");
        $(".Jigoku").html("地狱");
        $(".ReimuA").html("灵梦A");
        $(".ReimuB").html("灵梦B");
...
function swapTables() {
    ...
    $("#HSiFSsmall").css("display", seasonsEnabled
        ? "none"
        : "block");
    $("#HSiFS").css("display", seasonsEnabled
        ? "block"
        : "none");
    $("#HSiFSlink").attr("href", seasonsEnabled
        ? "#HSiFS"
        : "#HSiFSsmall")
}
            ...
            for (game in WRs) {
                ...
                for (difficulty in WRs[game]) {
                    ...
                    for (shottype in WRs[game][difficulty]) {
                        ...
                        player = wr[1];
                        date = wr[2];
                        replay = (wr[3] ? wr[3] : replayName(game + difficulty + shottype));
                        if (score > max) {
