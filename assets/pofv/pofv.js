var language = "English", STATS = {
    ...
    DESCRIPTION = {
        "youmu": {
            "English": "Her movement speeds allow her to be either very slow or very fast at will. " +
            ...
            "Chinese": "妖梦的高低速差距非常大，使得她在避弹时可控性强。她的C1几乎没有CD，所以她可以一直依赖她的C1进行防守，" +
        ...
        "marisa": {
            "English": "Marisa's charge attack not only instantly destroys spirits, but causes them to explode " +
            ...
            "Chinese": "魔理沙的C1可以秒杀灵并且引发激活状态的连爆。利用这个特性使她不需要固灵就可以在任何的地方引发连爆。" +
                "同时她的特性使她可以更频繁的使用C2。魔理沙高速C1可以扫屏清屏，并且能够很好的利用C1的无敌穿越弹幕。因此，" +
                "魔理沙的特性给予了她非常强大的生存能力。在进攻时，她的无法消除的EX激光将带给对方很大避弹压力，创造出很多无解的状况。" +
                "在开花战中，魔理沙是无可争议的最强机体。"
        },
        "reimu": {
            "English": "She's powerful because of her level 2 spell, which limits the opponent's movement and " +
            ...
            "Chinese": "灵梦的强大来自于C2攻击。她的C2可以限制对方的移动，并且持续的产生，导致她的C2很难被对手全部消掉。但是，" +
                "她同时也要承受对方消除C2后的很快速度的反击弹。灵梦的移动速度，固灵展开速度很慢，C1实用性较差，因此她的生存能力并不高。" +
                "总而言之，除了C2，灵梦的性能平庸。但是灵梦仅仅因为C2超强的进攻能力，使她成为了花映塚的顶级角色。"
        },
        "komachi": {
            "English": "Her awesome scope and auto-targeting charge attack give her a lot of freedom. " +
            ...
            "Chinese": "她可怕的固灵范围和诱导的C1给予了她非常大的自由度，甚至可以在场上的任何地方引发连爆。小町没有必要去追妖精或者灵，" +
        ...
        // Eiki
        "eiki": {
            "English": "Great movement speeds, scope, and charge attack. Her boss is also pretty good. " +
            ...
            "Chinese": "四季移速快，固灵大，C1性能好，Boss也很厉害。并且它的EX是复制对方的弹幕所形成的，在同一个轨迹上发射一个特殊的，" +
        ...
        // Lyrica
        "lyrica": {
            "English": "Lyrica's scope is similar to Marisa's, but is much harder to use due to her slowness. " +
            ...
            "Chinese": "莉莉卡的固灵和魔理沙相似，但是展开很慢，所以使用起来比魔理沙要难受很多。她的C1只是向前射击，并且停留在原地，" +
        ...
        // Medicine
        "medicine": {
            "English": "She boasts nice movement speeds and scope, and her ability to pass through spirits is sometimes useful. " +
            ...
            "Chinese": "毒药的移速和固灵都比较优秀，并且她可以碰到灵的能力有时可以发挥奇效。她的C1速度慢，而且C1效果很糟糕。" +
        ...
        // Yuuka
        "yuuka": {
            "English": "Her boss, spell, and Extra attacks give her a decent offense as they force the opponent downward, " +
            ...
            "Chinese": "幽香的Boss，EX和C2使她拥有一个不错的进攻性能，因为这些进攻的组合能够让对方被迫向下。但是她跑的太慢了，防守能力并不高。" +
        ...
        // Reisen
        "reisen": {
            "English": "Good defense, terrible offense; that is Reisen in a nutshell. Her spell creates too many bullets. " +
            ...
            "Chinese": "防守厉害进攻很差的机体就是铃仙。她的C2给对面太多子弹了，所以她只能赢那些蓄力速度很慢，在后期开花被淹死的机体。" +
                "铃仙本人则很擅长应对后期的开花，她的速度快，蓄力快，C1能打得远。尽管如此，厉害的花映塚玩家之间，只要有人祭出铃仙，" +
                "那么她们的比赛很容易打上半个小时，无论哪边更厉害一点。总而言之，铃仙虽然不是很厉害，但是她能够打击对方的膀胱，有潜在的杀伤力。"
        },
        // Sakuya
        "sakuya": {
            "English": "Her focused movement speed is barely different from her normal speed. This is strictly a weakness: " +
                ...
                "knife-throwing maid.",
            "Chinese": "她的高低速没啥区别，算是个缺点，因为她很难精确的定位，并且需要大范围拉扯的时候又比较慢。她的固灵很难受，C1比灵梦还差。" +
        ...
        // Lunasa
        "lunasa": {
            "English": "While her movement and charge speeds are good, her defense is still a bit low thanks to " +
            ...
            "Chinese": "她的移速和蓄力速度虽然都很快，但是她的射程和三方向子弹让她的防守并不是那么的优秀。她的进攻一般般，C2很慢，没啥进攻能力。" +
            "她的EX可以堆积并限制对方的移动空间，但是又很慢，很容易像文那样流出屏幕。她的Boss没啥用，而且还有一种能给对方带来大量白弹的进攻。" +
            "整体上平庸的进攻能力和防守能力让露娜萨只能是个弱机。"
        },
        // Merlin
        "merlin": {
            "English": "Her movement, scope, and charge speed are all very slow. " +
                ...
                "of the lowest tier.",
            "Chinese": "移动速度慢，蓄力速度慢，固灵展开慢，而且固灵是个横向莉莉卡，C1也是横向的。她的点射不是向上的，而是左边往右，" +
        ...
        // Aya
        "aya": {
            "English": "Her focused speed is uncomfortably fast. Her spell and Extra attack aren't individually terrible, but " +
            ...
            "Chinese": "她低速移动太快了影响了自己的避弹，而且C2和EX并没有太大的杀伤，而且效果相同，所以对方只要微移躲狙就行了。" +
                "尽管这样，文开局的进攻还是很厉害的，尤其Boss在场的时候，对方很难向上移动。她主要问题是她的返弹太快了。她固灵使用很困难，" +
                "并且需要承受成吨的她本身的C2返弹。由于她防守很差，进攻有，但是不出色，所以她很难赢得大部分的比赛。"
        },
        // Mystia
        "mystia": {
            "English": "Defensively, she's not bad. Good speeds, fast scope, and an acceptable charge attack. " +
            ...
            "Chinese": "防守很强的机体。移动速度和蓄力速度都不错，固灵很舒服，C1也还凑合。但是她进攻能力太差了。她C2要一万年才能动，" +
                "而且就算动了子弹速度也很慢。你可能会认为她C2发生的慢可以让对方难以消除，但是你只要消掉领头的小鸟，整个C2就没了。" +
                "包括Boss的攻击和EX。这机体进攻速度太慢了，所以导致了她在整个花映塚机体排位中在底层。"
        },
        // Cirno
        "cirno": {
            "English": "She's fast and has an okay scope. She charges a bit slowly, but this doesn't matter too much. " +
            ...
            "Chinese": "她移动速度快，固灵速度也不错。蓄力有点慢，但是不重要。她的C2攻击会创建一个子弹环，" +
        ...
        // Tewi
        "tewi": {
            "English": "Fast while unfocused, slow when focused. Her charge speed is excellent. " +
            ...
            "Chinese": "固灵时移速慢，不固灵时速度很快，蓄力速度也很快。但是她的固灵展开很慢，而且形状很差，就像梅露兰那样。" +
...
$(document).ready(function () {
    if (getCookie("lang") == "Chinese" || location.href.contains("zh")) {
        language = "Chinese";
    }
