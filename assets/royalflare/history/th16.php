...
<table class='HSiFSt'>
	...
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('ReimuAutumn', $lang_code) ?></td>
		<td>Ｋ・Ｇ</td>
		<td>742,842,010</td>
	</tr>
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('ReimuSummer', $lang_code) ?></td>
		<td>Andrew</td>
		<td>1,170,241,780</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('ReimuWinter', $lang_code) ?></td>
		<td>HRS</td>
		<td>1,547,947,340</td>
	</tr>
	<tr>
...
<table class='HSiFSt'>
	...
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('MarisaAutumn', $lang_code) ?></td>
		<td>Ｋ・Ｇ</td>
		<td>435,486,450</td>
	</tr>
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('MarisaSpring', $lang_code) ?></td>
		<td>もゆみ</td>
		<td>444,974,490</td>
	</tr>
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('MarisaSummer', $lang_code) ?></td>
	...
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('MarisaWinter', $lang_code) ?></td>
		<td>レックス</td>
		<td>1,411,240,840</td>
	</tr>
	<tr>
...
<table class='HSiFSt'>
	...
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('CirnoAutumn', $lang_code) ?></td>
		<td>Ｋ・Ｇ</td>
		<td>575,328,500</td>
	</tr>
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('CirnoSummer', $lang_code) ?></td>
		<td>P.K</td>
		<td>1,156,583,720</td>
	</tr>
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('CirnoSummer', $lang_code) ?></td>
		<td><?php echo tl_shot('Cirno', $lang_code) ?></td>
		<td>1,218,197,910</td>
	</tr>
	<tr>
		<td>4</td>
	...
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('CirnoWinter', $lang_code) ?></td>
		<td>レックス</td>
		<td>1,405,036,830</td>
	</tr>
	<tr>
...
<table class='HSiFSt'>
	...
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('AyaSummer', $lang_code) ?></td>
		<td>Ｋ・Ｇ</td>
		<td>688,415,280</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('AyaSummer', $lang_code) ?></td>
		<td><?php echo tl_shot('Aya', $lang_code) ?></td>
		<td>1,051,115,630</td>
	</tr>
	<tr>
		<td>4</td>
	...
	<tr>
		...
		<td>Easy</td>
		<td><?php echo tl_shot('AyaWinter', $lang_code) ?></td>
		<td><?php echo tl_shot('Aya', $lang_code) ?></td>
		<td>1,562,346,680</td>
	</tr>
	<tr>
...
<table class='HSiFSt'>
	...
	<tr>
		...
		<td>Normal</td>
		<td><?php echo tl_shot('ReimuSpring', $lang_code) ?></td>
		<td>Ｋ・Ｇ</td>
		<td>108,408,960</td>
	</tr>
	<tr>
...
<table class='HSiFSt'>
	...
	<tr>
		...
		<td>Normal</td>
		<td><?php echo tl_shot('AyaAutumn', $lang_code) ?></td>
		<td>yuushaou</td>
		<td>3,327,329,020</td>
	</tr>
	<tr>
		...
		<td>Normal</td>
		<td><?php echo tl_shot('AyaSpring', $lang_code) ?></td>
		<td>yuushaou</td>
		<td>3,678,384,480</td>
	</tr>
	<tr>
