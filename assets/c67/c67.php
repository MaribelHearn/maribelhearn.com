<div id='wrap' class='wrap'>
    ...
    <picture>
        ...
        <source srcset='assets/c67/images/boxart.jpg'>
        <img id='boxart' src='assets/c67/images/boxart.jpg' alt='Banshiryuu Cover' width='280' height='280'>
    </picture>
    <hr>
    ...
    <picture>
        <source srcset='assets/c67/images/item_rank.webp' type='image/webp'>
        <source srcset='assets/c67/images/item_rank.jpg'>
        <img loading='lazy' src='assets/c67/images/item_rank.jpg' alt='Point item sprites' width='219' height='38'>
    </picture>
    ...
    <picture>
        <source srcset='assets/c67/images/grazing.webp' type='image/webp'>
        <source srcset='assets/c67/images/grazing.png'>
        <img id='graze' loading='lazy' src='assets/c67/images/grazing.png' alt='VIVIT grazing lasers' width='350' height='145'>
    </picture>
    <br>
    ...
    <picture>
        <source srcset='assets/c67/images/normal_se.webp' type='image/webp'>
        <source srcset='assets/c67/images/normal_se.jpg'>
        <img loading='lazy' src='assets/c67/images/normal_se.jpg' alt='SE-attack' width='210' height='280'>
    </picture>
    ...
    <picture>
        <source srcset='assets/c67/images/se.webp' type='image/webp'>
        <source srcset='assets/c67/images/se.jpg'>
        <img loading='lazy' src='assets/c67/images/se.jpg' alt='Damage dealt to SE' width='208' height='64'>
    </picture>
    <br>
    ...
    <picture>
        <source srcset='assets/c67/images/final_se.webp' type='image/webp'>
        <source srcset='assets/c67/images/final_se.jpg'>
        <img loading='lazy' src='assets/c67/images/final_se.jpg' alt='Final SE-attack' width='209' height='280'>
    </picture>
    <br>
    ...
    <picture>
        <source srcset='assets/c67/images/yuitia.webp' type='image/webp'>
        <source srcset='assets/c67/images/yuitia.png'>
        <img id='yuitia' loading='lazy' src='assets/c67/images/yuitia.png' alt='Yuitia (final boss)' width='235' height='457'>
    </picture>
    <br>
    ...
    <picture>
        <source srcset='assets/c67/images/vivitw.webp' type='image/webp'>
        <source srcset='assets/c67/images/vivitw.jpg'>
        <img loading='lazy' class='shotinfo' src='assets/c67/images/vivitw.jpg' alt='VIVIT-W Shottype Info' width='640' height='480'>
    </picture>
    <br>
    ...
    <picture>
        <source srcset='assets/c67/images/vivita.webp' type='image/webp'>
        <source srcset='assets/c67/images/vivita.jpg'>
        <img loading='lazy' class='shotinfo' src='assets/c67/images/vivita.jpg' alt='VIVIT-A Shottype Info' width='640' height='480'>
    </picture>
    <br>
    ...
    <picture>
        <source srcset='assets/c67/images/hiranos.webp' type='image/webp'>
        <source srcset='assets/c67/images/hiranos.jpg'>
        <img loading='lazy' class='shotinfo' src='assets/c67/images/hiranos.jpg' alt='HiranoS Shottype Info' width='640' height='480'>
    </picture>
    <br>
    ...
    <picture>
        <source srcset='assets/c67/images/hiranoo.webp' type='image/webp'>
        <source srcset='assets/c67/images/hiranoo.jpg'>
        <img loading='lazy' class='shotinfo' src='assets/c67/images/hiranoo.jpg' alt='HiranoO Shottype Info' width='640' height='480'>
    </picture>
    <br>
