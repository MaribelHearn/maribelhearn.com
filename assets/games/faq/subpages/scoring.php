...
what you could do is scout different replays of different scores, and see what scores and strategies feel completely unreasonable,
...
other have bad early games, but good late games, this way having multiple replays helps you understand what is a good score/PiV pace with an average early and late game.
Recent dates are ideal because recent scores tend to have more refined/easier strategies than older ones,
which might have suboptimal/harder strategies for the same score gain.</p>
...
<p>The first type of replays helps you understand what numbers are <span class='plain_red'>MANDATORY</span> if you want to get that score goal,
...
<p>The second types of replays are important because if you just practice routes that can just barely score your goal, your play is gonna require perfection,
...
Getting used to your route is the important part, you ideally want to <span class='plain_red'>start practicing starting from STAGE 1</span>,
if you do this and progress stage by stage, it's gonna help you build your route,
...
and this forces re-routing the later stage.
What you can do, and I advise doing, is <span class='plain_red'>practice single patterns of later stages</span>,
...
from a good player of your category can come in clutch since they can help you figure out which strategy to nerf/drop entirely for your goal).
...
while hard to execute, inconsistent complicated strategies
...
and depending on how behind/ahead you are compared to your SoB, you can make choices,
...
<h4 id='games'>Scoring Gameplay Summary Game by Game</h4>
...
and unnecessary deaths hurt, as they give a nice score boost in the end clear bonus.</p>
...
and killing enemies, and you chain items and enemy kills to maintain the bar high.
The SCBs increase the higher your PiV, capping as many spell cards as possible is ideal,
and clearing with as many lives as possible is also ideal because not only does dying lose a huge amount of PiV,
...
Items collected with a full CG are collected at full value, doing a PoC instantly fills the CG, the CG is normally filled by graze.
...
Flashing UFOs also replace power items into point items when they are collected and vice-versa,
so they are also used in sections mostly containing power items (with an x4 PiV multiplier).
Players may also opt to summon Red UFOs instead because Touhou 12 requires high survival skills
and more resources can help with keeping a run alive after accidental deaths. Ichirin both mid-boss and boss,
...
the number of spirits spawned to increase PiV quickly, this is done by killing enemies quickly (which spawns more spirits)
...
The value of point items can be increased by grazing bullets and canceling bullets via nons/spells cancels
and bombs on nons (SakuyaB can also bomb spells) doing a PoC gives the player a score bonus based on the items collected,
the bonus is a multiplier that goes to the total score gained from the PoC.
...
The value of point items can be increased by grazing [only regular graze, not Graze items (GI)],
green items spawned from cancels, and chapter bonuses (the PiV bonus is equal to graze,
however, this PiV bonus does benefit from GI). The chapter bonuses give a score equal
to a formula of graze and % of the shootdown. LoLK has more lives and resources than most games,
almost all of them tend to be used to suicide repeatedly to graze with Iframes or bombs,
the best example of this is Ringo's second spell, spawn grazing and GI items are most of the graze obtained.
...
but in the late game losing as few lives as possible is ideal to not lose the power to point item conversion at full power.</p>
...
and by canceling bullets with Otter spirits and nons/spell cancels,
most of the green items are generated by otter spirits.
WBaWC routing is made to allow players to hyper as many times as possible on the juiciest sections in the stage,
...
<p><a href='/royalflare'><span class='icon royalflare_icon'></span> Royalflare Archive</a> archives Royalflare. Royalflare was a site that used to archive replays which shut down in early 2022. Any scoring replay reference from before 2022 can be found here.</p>
...
replays here require a minimum score to be admitted, the minimal entries here vary from simple for some games,
...
<p><a href='https://discord.gg/xU3utzg'><span class='icon discord_icon'></span> Touhou Replay Community</a>  is the biggest hub for the western discord community
as of me currently writing this guide, anyone is welcome here, we have new players, old-time players, big community figures, and scorers,
