...
document.getElementById("age_summary").addEventListener("click", function wrap() { toggle(true); });
document.getElementById("age_detail").addEventListener("click", function wrap() { toggle(false); });
