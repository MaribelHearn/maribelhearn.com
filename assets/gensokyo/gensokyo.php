...
<div id='wrap' class='wrap'>
    ...
    <form>
        ...
        <p id='conditions'>
            <span><label for='nd'><img src='assets/gensokyo/gif/nd.gif' title='No Deaths' alt='No Deaths icon'></label><br>
            <input id='nd' name='nd' type='checkbox'<?php echo !empty($_GET['nd']) && $_GET['nd'] == 'on' ? ' checked' : '' ?>></span>
            <span><label for='nb'><img src='assets/gensokyo/gif/nb.gif' title='No Bomb Usage' alt='No Bombs icon'></label><br>
            <input id='nb' name='nb' type='checkbox'<?php echo !empty($_GET['nb']) && $_GET['nb'] == 'on' ? ' checked' : '' ?>></span>
            <span><label for='nf'><img src='assets/gensokyo/gif/nf.gif' title='No Focused Movement' alt='No Focus icon'></label><br>
            <input id='nf' name='nf' type='checkbox'<?php echo !empty($_GET['nf']) && $_GET['nf'] == 'on' ? ' checked' : '' ?>></span>
            <span><label for='nv'><img src='assets/gensokyo/gif/nv.gif' title='No Vertical Movement' alt='No Vertical icon'></label><br>
            <input id='nv' name='nv' type='checkbox'<?php echo !empty($_GET['nv']) && $_GET['nv'] == 'on' ? ' checked' : '' ?>></span>
            <span><label for='tas'><img src='assets/gensokyo/gif/tas.gif' title='Tool-Assisted Replay' alt='TAS icon'></label><br>
            <input id='tas' name='tas' type='checkbox'<?php echo !empty($_GET['tas']) && $_GET['tas'] == 'on' ? ' checked' : '' ?>></span>
            <span><label for='chz'><img src='assets/gensokyo/gif/chz.gif' title='Tool-Assisted Replay (not marked by original uploader)' alt='Cheater icon'></label><br>
            <input id='chz' name='chz' type='checkbox'<?php echo !empty($_GET['chz']) && $_GET['chz'] == 'on' ? ' checked' : '' ?>></span>
            <span><label for='pa'><img src='assets/gensokyo/gif/pa.gif' title='Pacifist' alt='Pacifist icon'></label><br>
            <input id='pa' name='pa' type='checkbox'<?php echo !empty($_GET['pa']) && $_GET['pa'] == 'on' ? ' checked' : '' ?>></span>
            <span><label for='co'><img src='assets/gensokyo/gif/co.gif' title='Other Condition' alt='Other icon'></label><br>
