...
function hit($page) {
    if (file_exists('.stats/token')) {
        ...
        $bot = strpos($_SERVER['HTTP_USER_AGENT'], 'bot') || strpos($_SERVER['HTTP_USER_AGENT'], '-Google') || strpos($_SERVER['HTTP_USER_AGENT'], 'w3c') || strpos($_SERVER['HTTP_REFERER'], 'developers.google');
