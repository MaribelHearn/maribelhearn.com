<!DOCTYPE html>
<html id='top' lang='<?php if (empty($_GET['hl'])) { echo 'en'; } else { echo str_replace('ru', 'zh', $_GET['hl']); } ?>'>
<?php
	include 'assets/shared/shared.php';
	include 'assets/tools/tools.php';
        ...
        <main>
            <div id='wrap' class='wrap'>
				<div id='topbar'>
					<p id='ack'>
						<?php
							if ($lang == 'Russian') { echo 'Иллюстрацию на фоне нарисовал(а) ' .
				...
				?></p>
                <h2 id='contents'><?php if ($lang == 'Russian') { echo 'Содержание'; } else { echo 'Contents'; } ?></h2>
                <div class='border'>
                    <p><a href='#vpatch'>Vpatch</a></p>
                    <p><a href='#thcrap'>THCRAP</a></p>
                    <p><a href='#enbconvertor'><strong><?php
						if ($lang == 'Russian') { echo 'Для'; } else { echo 'For'; }
					?> Windows 10:</strong> DX8 to DX9</a></p>
                    <p><a href='#scorefiles'><?php
						if ($lang == 'Russian') { echo 'Полные скорфайлы'; } else { echo 'Completed Scorefiles'; }
					?></a></p>
                    <p><a href='#thprac'><strong>THprac</strong></a></p>
                    <p><a href='#spoileral'>SpoilerAL</a></p>
                    <p><a href='#practools'><?php
						if ($lang == 'Russian') { echo 'Общие инструменты для практики'; } else { echo 'General Practice Tools'; }

					?></a></p>
                    <p><a href='#bossrush'><?php
						if ($lang == 'Russian') { echo 'Боссраш патчи'; } else { echo 'Boss Rush Patches'; }
					?></a></p>
                    <p><a href='#specific'><?php
						if ($lang == 'Russian') { echo 'Практика определенных паттернов'; } else { echo 'Specific Pattern Practice'; }
					?></a></p>
                    <p><a href='#shottypes'><?php
						if ($lang == 'Russian') { echo 'Модификации шоттипов'; } else { echo 'Shottype Modifications'; }
					?></a></p>
                    <p><a href='#hardultra'><?php
						if ($lang == 'Russian') { echo 'Хард мод / Ультра патчи'; } else { echo 'Hard Mode / Ultra Patches'; }
					?></a></p>
                    <p><a href='#graphical'><?php
						if ($lang == 'Russian') { echo 'Графические патчи'; } else { echo 'Graphical Patches'; }
					?></a></p>
                    <p><a href='#emulators'><?php
						if ($lang == 'Russian') { echo 'Эмуляторы PC-98'; } else { echo 'PC-98 Emulators'; }
					?></a></p>
                    <p><a href='#miscellaneous'><?php
						if ($lang == 'Russian') { echo 'Прочее'; } else { echo 'Miscellaneous'; }
					?></a></p>
                ...
                <p><?php
					if ($lang == 'Russian') {
						...
						'этих играх.</p><p>Vpatch можно поставить на все официальные шмапы, кроме HSiFS и WBaWC.</p>';
					} else {
						...
						'experience.</p><p>Vpatch is applicable to all official shooting games bar HSiFS and WBaWC.';
					}
                ...
                <div>
                    <p><a href='http://wcs.main.jp/index/software/spal/' target='_blank'><?php
						if ($lang == 'Russian') { echo 'Главная программа'; } else { echo 'Main Program'; }
					?></a></p>
    				<p class='wide-top'><a href='https://maribelhearn.com/mirror/4.6_SSGs.zip' target='_blank'><?php
						if ($lang == 'Russian') { echo 'Пак SSG (4.6)'; } else { echo 'SSG Pack (4.6)'; }
					?></a></p>
    				...
    				<p><a href='https://mega.nz/#!OpxFSSJB!2eUH91vJAF_ejq7S5r3x5Jx7GYCP67LSSo4BuXhoDa4' target='_blank'><?php
						if ($lang == 'Russian') { echo 'Пак SSG (niL)'; } else { echo 'SSG Pack (niL)'; }
					?></a></p>
                    <p><a href='https://cdn.wikiwiki.jp/to/w/let/etc/%E3%83%97%E3%83%AD%E3%82%B0%E3%83%A9%E3%83%A0%E3%81%AA%E3%81%A9/SpoilerAL%E7%94%A8%E3%81%AESSG%E3%83%95%E3%82%A1%E3%82%A4%E3%83%AB/::attach/th_ssg20080502.zip?rev=8b2466505ba323da7fc610fad805213f&t=20120111011846'><?php
						if ($lang == 'Russian') { echo 'Пак SSG (LET)'; } else { echo 'SSG Pack (LET)'; }
					?></a></p>
                    ...
                    <p><a href='https://mega.nz/#!QUBTEB5J!idRbiOfr_BKFpMBy9e5qU5Ow1xPkxplVbR72G6Ud0KI' target='_blank'><?php
						if ($lang == 'Russian') { echo 'MoF SSG от Akaldar'; } else { echo 'MoF SSG by Akaldar'; }
					?></a></p>
                    <p><a href='https://mega.nz/#!BJwhwYRB!5Zgr6redSWbA2v2vco0b7k00XH-BIeTAPUnW28gI-20' target='_blank'><?php
						if ($lang == 'Russian') { echo 'GFW SSG (с английским переводом)'; } else { echo 'GFW SSG (English translated)'; }
					?></a></p>
    				...
    				<p><a href='https://maribelhearn.com/mirror/th16_score.ssg' target='_blank'><?php
						if ($lang == 'Russian') { echo 'HSiFS Scoring SSG от Sonitsuku'; } else { echo 'HSiFS Scoring SSG by Sonitsuku'; }
					?></a></p>
                    <p><a href='https://gitlab.com/32th/th14ssg' target='_blank'><?php
						if ($lang == 'Russian') { echo 'DDC SSG от 32th System'; } else { echo 'DDC SSG by 32th System'; }
					?></a></p>
    				<p><a href='https://mega.nz/#!cAwknKTB!3PCN0me2Q3uTXwo4VgfBIouOqf5W0spBEhZwwR2uNfA' target='_blank'><?php
						if ($lang == 'Russian') { echo 'LoLK SSG от CreepyNinja'; } else { echo 'LoLK SSG by CreepyNinja'; }
					?></a></p>
				...
				?></p>
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'Инструменты для практики от '; } else { echo 'Practice Tools by '; }
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'Практика для WBaWC от '; } else { echo 'WBaWC Practice by '; }
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'GFW "Brown Label" от '; } else { echo 'GFW "Brown Label" Practice by '; }
				...
				?></p>
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Боссраш патчи от '; } else { echo 'Boss Rush Patches by '; }
                ...
                <div>
    				<p><a href='https://maribelhearn.com/mirror/Full%20Boss%20Rush.zip' target='_blank'><?php
						if ($lang == 'Russian') { echo 'Полный пак'; } else { echo 'Full Pack'; }
					?></a></p>
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Боссраш EoSD от '; } else { echo 'EoSD Boss Rush by '; }
                ...
                <p><?php
					if ($lang == 'Russian') { echo 'Боссраш патч для PCB.'; } else { echo 'A boss rush patch for PCB.'; }
				?></p>
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'Боссраш WBaWC от '; } else { 'WBaWC Boss Rush by '; }
				?>Plus</strong></p>
                <p><?php
					if ($lang == 'Russian') { echo 'Боссраш патч для WBaWC.'; } else { echo 'A boss rush patch for WBaWC.'; }
				?></p>
				...
				?></p>
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Практика книг в EoSD от '; } else { echo 'Books Practice for EoSD by '; }
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Практика нонспеллов в IN'; } else { echo 'IN Nonspell Practice'; }
				?></strong></p>
                <p><?php
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Коллекция фаз таймаутов от '; } else { echo 'Timeout Phase Collection by '; }
				?><a href='https://twitter.com/ReformedSmol' target='_blank'>Martin</a></strong></p>
                <p><?php
					if ($lang == 'Russian') {
                ...
                <div>
                    <p><a href='https://mega.nz/#F!yhwiWaTD!4AE7YYzsfixx1yXIGFcbdg' target='_blank'><?php
						if ($lang == 'Russian') { echo 'От MoF до LoLK'; } else { echo 'MoF to LoLK'; }
					?></a></p>
				...
				?></h2>
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'MoF Рейсен от '; } else { echo 'MoF Reisen by '; }
				?>Kayu</strong></p>
    			<p><?php
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'UFO Цубакура от '; } else { echo 'UFO Tsubakura mod by '; }
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'DDC Санаэ от '; } else { echo 'DDC Sanae by '; }
				?><a href='https://twitter.com/Priweejt' target='_blank'>Priw8</a></strong>
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'LoLK Сакуя от '; } else { echo 'LoLK Sakuya by '; }
				?><a href='https://twitter.com/Priweejt' target='_blank'>Priw8</a></strong>
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'TD Юка от '; } else { echo 'TD Yuuka by '; }
				?>Gamer251</strong></p>
    			<p><?php
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'DS Сейджа от '; } else { echo 'DS Seija by '; }
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'WBaWC (Демо) Рейсен от '; } else { echo 'WBaWC (Demo) Reisen by '; }
				?>Kayu</strong></p>
				...
				?></p>
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'WBaWC Наруми от '; } else { echo 'WBaWC Narumi by '; }
				?>Kayu</strong></p>
    			<p><?php
                ...
                <div>
                    <p><a href='http://cheater.seesaa.net/category/9478192-1.html' target='_blank'><?php
						if ($lang == 'Russian') { echo 'Главные ультра патчи'; } else { echo 'Main Ultra Patches'; }
					?></a></p>
                    <p><a href='https://www.axfc.net/u/785101' target='_blank'><?php
						if ($lang == 'Russian') { echo 'Альтернативная ультра для EoSD'; } else { echo 'Alternate EoSD Ultra'; }
					?></a></p>
                </div>
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Хард моды от '; } else { echo 'bHard Mode patches by '; }
				?><a href='https://twitter.com/chirpeh13' target='_blank'>Chirpy</a></strong></p>
                <p><?php
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'IN Двойной стейдж '; } else { echo 'IN Double Stage '; }
				?>4/6</strong></p>
                <p><?php
					if ($lang == 'Russian') {
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'HSiFS УльтраБ от '; } else { echo 'HSiFS UltraB by '; }
				?><a href='https://twitter.com/mdude33' target='_blank'>Dass</a></strong></p>
                <p><?php
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'OC патчи от '; } else { echo 'OC Patches by '; }
				?>Bravi</strong>
				...
				?></p>
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Графические патчи от '; } else { echo 'Graphical Patches by '; }
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'Вертикальные патчи от '; } else { echo 'Vertical Play Patches by '; }
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Трекер капрейта в EoSD от '; } else { echo 'EoSD Capture History Tracker by '; }
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Фикс сохранения реплеев в PoFV'; } else { echo 'PoFV Replay Save Crash Fixer'; }
				?></strong></p>
                <p><?php
					if ($lang == 'Russian') {
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'TD Arrange от '; } else { echo 'TD Arrange Patch by '; }
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'HSiFS максимальные сезоны от '; } else { echo 'HSiFS Max Season Start by '; }
				?><a href='https://twitter.com/ReformedSmol' target='_blank'>Martin</a></strong></p>
                <p><?php
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Polished Shooting Star от '; } else { echo 'Polished Shooting Star by '; }
                ...
                <p><strong><?php
					if ($lang == 'Russian') { echo 'Дисплей инпутов от '; } else { echo 'Input Display by '; }
				?><a href='https://twitter.com/drakeirving' target='_blank'>Drake</a></strong></p>
                <p><?php
    			...
    			<p><strong><?php
					if ($lang == 'Russian') { echo 'HSiFS UFO мод от '; } else { echo 'HSiFS UFO mod by '; }
				?><a href='https://twitter.com/Priweejt' target='_blank'>Priw8</a></strong>
    			...
    			<p><?php
					if ($lang == 'Russian') { echo 'Добавляет НЛО в HSiFS.'; } else { echo 'Adds UFOs to HSiFS.'; }
				?></p>
                ...
                <div id='ack_container'>
					...
					?><a href='https://www.pixiv.net/member.php?id=66609'>青葉</a>.</p>
				</div>
