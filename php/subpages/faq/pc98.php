...
<p>Click an emulator icon to download it, already configured for Touhou on Windows.</p>
...
<table id='emus' class='noborders'>
    <thead>
        <tr>
            ...
            <td><a href='https://github.com/spaztron64/th98tuc_site/raw/main/packages/2022_04_12/np21_nogame.zip'><img src='/assets/games/faq/pc98/Neko.ico' alt='Neko Project 21 icon' class='emu'></a></td>
            <td><a href='https://github.com/spaztron64/th98tuc_site/raw/main/packages/2022_04_12/dosboxx_nogame.zip'><img src='/assets/games/faq/pc98/Dosbox.ico' alt='DOSBox icon' class='emu'></a></td>
        </tr>
    </thead>
    <tbody>
        <tr id='emu_names'>
...
<p>As shown in the summary above, DOSBox-X is the only emulator that supports Mac and Linux. Alternatively, <a href='https://www.retroarch.com/' target='_blank'>RetroArch</a>
can run Neko Project; see the next section for how to do this.</p>
...
<p><a href='https://maribelhearn.com/mirror/PoDDofire.ahk'>SoEWofire.ahk</a></p>
...
<p>To load a game, click the three dots "..." next to HDD1 and click your desired <span class='code'>.hdi</span> file. Click the Start button to launch it. Before getting started, click Config to improve the sound quality,
as it is not great by default.</p>
...
Ope the Stat tab and click "Title" to change your current savestate collection. Any savestate you make will have the title in its name. This allows you to make essentially infinite savestates. To load a savestate from a different collection,
...
<p>Open the Device tab, then Memory, and set it to at least 13.6 MB.</p>
