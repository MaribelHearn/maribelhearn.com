...
if (strpos($games, 'Internal Server Error') !== false) {
    ...
    die();
} else if (strpos($games, 'Service Unavailable') !== false || strpos($games, 'Not Found') !== false) {
    $_GET['error'] = 503;
    include_once('php/error.php');
    include_once('php/shared/postscript.php');
    die();
...
<div id='wrap' class='wrap'>
    ...
    <?php
        ...
        if ($layout == 'New') {
            ...
            '<p><a href="#players" class="playerranking">' . _('Player Statistics') . '</a></p>' .
            '</div><noscript>';
        }
        ...
        echo '<p><a href="#players" class="playerranking">' . _('Player Statistics') . '</a></p></div>';
        if ($layout == 'New') {
            echo '</noscript>';
        }
    ?>
