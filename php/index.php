<div id='wrap' class='wrap'>
    ...
    <div>
        ...
        <div class='pages_right'>
            ...
            <ul class='page_table'>
                <li class='link'>
                    <a href='/thvote'><span class='icon thvote_icon'></span> THWiki Popularity Poll 2022 Results Translation</a>
                    <span class='tooltip'>Complete English translation of the full results of the THWiki Popularity Poll held in 2022.</span>
                </li>
                <li class='link'>
        ...
        <div id='touhou_world_cup'>
            ...
            <p class='wide center'>Touhou World Cup 2023 signups are open! Visit <span class='icon twc_icon'></span> <a href='https://touhouworldcup.com'>touhouworldcup.com</a> for more information.</p>
        </div>
