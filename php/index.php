<div id='wrap' class='wrap'>
    ...
    <div>
        ...
        <div class='pages_right'>
            ...
            <ul class='page_table'>
                <li class='link'>
                    <a href='/thvote'><span class='icon thvote_icon'></span> THWiki Popularity Poll 2025 Results Translation</a>
                    <span class='tooltip'>Complete English translation of the full results of the THWiki Popularity Poll held in 2025.</span>
                </li>
                <li class='link'>
            ...
            <ul class='page_table'>
                <li class='link'>
                    <a href='/about'><span class='icon'></span> About Me</a>
                    <span class='tooltip'>Personal introduction as well as some random facts.</span>
                </li>
                <li class='link'>
                    <a href='/history'><span class='icon history_icon'></span> Shmup Achievement History</a>
                ...
                <li class='link'>
                    ...
                    <span class='tooltip'>Explanation of scoring in Banshiryuu C67, the earlier version of the third Seihou game.</span>
                </li>
            </ul>
        </div>
        <div>
        ...
        <div id='special_thanks'>
            ...
            <p class='center'>Taishisamaaa, Omega, MeFigaYoma, Sodamachine, guy, 32th System, Redaction, Kawaii_Shadowii, Isaac, yeashie, めいたむ, hakatashi, Famas2995, RB, Moo, patchouli and anonymous supporters</p>
        </div>
    </div>
    <footer id='bottom'>
