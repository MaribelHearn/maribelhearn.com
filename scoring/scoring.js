...
function checkAll() {
    var checked = $("#all").is(":checked"), key;
...
var calc = function () {
    var top = {}, averages = {}, shown = {}, total = 0, categories = 0, highest = 0,
...
var loadShownCookie = function () {
    var shownCookie = getCookie("shown"), game;

    for (game in shownCookie) {
        if (!shownCookie[game]) {
            hide(game);
        }
    }
